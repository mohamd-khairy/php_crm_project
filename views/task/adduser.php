...
<div class="row">
    <?php
    $data = TaskModel::get_all_task_and_user_by_acc_id($_SESSION['acc_id']);
    // print_r($data);
    ?>
    <div class="col-md-4">
        <!-- /.box-header -->
                                ...
                                if ((!empty($call['task_method']) ) && $call['task_method'] == 'call') {
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="index.php?rt=Task/showone&m=call&task_id=<?= $call['task_id'] ?>" class="product-title"><?= $call['user_name'] ?>
                            ...
                            if ($call['acc_id'] == $_SESSION['acc_id']) {
                                ...
                                if (!empty($call['task_method']) && $call['task_method'] == 'email') {
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="index.php?rt=Task/showone&m=email&task_id=<?= $call['task_id'] ?>" class="product-title"><?= $call['user_name'] ?>
                                                <?php if ($call['task_periority'] == 'hard') { ?>
                                                    <span class="label label-danger pull-right"><?= $call['task_periority'] ?></span></a>
                                            <?php } elseif ($call['task_periority'] == 'normal') { ?>
                            ...
                            if ($call['acc_id'] == $_SESSION['acc_id']) {
                                ...
                                if (!empty($call['task_method']) && $call['task_method'] == 'meeting') {
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="index.php?rt=Task/showone&m=meeting&task_id=<?= $call['task_id'] ?>" class="product-title"><?= $call['user_name'] ?>
                                                <?php if ($call['task_periority'] == 'hard') { ?>
                                                    <span class="label label-danger pull-right"><?= $call['task_periority'] ?></span></a>
                                            <?php } elseif ($call['task_periority'] == 'normal') { ?>

<div class="box box-warning">
    ...
    <div class = "row" style="direction: rtl">
        <?php
        $dataa = UserModel::getAllData_by_acc_id($_SESSION['acc_id']);
        ?>      
        <form action="?rt=task/adduser" method="post" enctype="multipart/form-data">

            <!-- contact array-->
            <div class="form-group has-success" style="margin-left: 15%; margin-right: 25%">
                <label class="control-label" for="inputError"><i class="fa fa-user"></i> الموظف:</label>
                ...
                <span class="help-block">اختار اسم الموظف ...</span>
            </div>

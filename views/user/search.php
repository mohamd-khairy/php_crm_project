                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table no-margin">
                            ...
                            <tbody>
                                <?php foreach ($datacontact as $data) { ?>
                                    <tr>
                                ...
                                <?php foreach ($datauser as $data) { ?>
                                    <tr>
                                        <td>
                                            <div class="sparkbar" data-color="#00a65a" data-height="20"><?= $data['user_date'] ?></div>
                                        </td>   
                                        <td><?= $data['user_other'] ?></td>
                                        <td><span class="label label-success"><?= $data['user_job'] ?></span></td>
                                        <td><?= $data['user_address'] ?></td>
                                        <td><a href="#"><?= $data['user_phone'] ?></a></td>
                                        <td><a href="?rt=User/profile&user_id=<?= $data['user_id'] ?>"><?= $data['user_name'] ?></a></td>
                                        <td><img src="<?= HostName . DS . 'img' . DS . $data['user_image'] ?>" width="50" height="50" /></td>

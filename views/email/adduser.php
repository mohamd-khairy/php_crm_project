...
<section class="content-header">
    ...
    <div class="box box-warning">
        ...
        <div class="box-body" style="direction: rtl">
            <form action="?rt=Email/senduser" method="post" enctype="multipart/form-data" id="myForm">
                ...
                <div class="form-group has-success" style="margin-left: 15%; margin-right: 25%">
                    ...
                    <select name="email" class="form-control" id="email">
                        ...
                        foreach ($data as $con) {
                            ...
                            <option  value="<?= $con['user_email'] ?>"><?= $con['user_name']  ?></option>
                        <?php }}}else{ ?>
                ...
                <div class="form-group has-error" style="margin-left: 15%; margin-right: 25%">
                    ...
                    <input type="text" name="email_content" class="form-control" id="content" placeholder="ادخل ...">
